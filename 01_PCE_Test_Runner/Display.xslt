...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
				<div class="PageTitle">
					Grade Results for <xsl:value-of select="//StudentTrackerGradeDigest/@ExerciseName"/>
            </div>
				<div class="TimeStamp">
					(This test was run at <xsl:value-of select="//StudentTrackerGradeDigest/@TestDateTime"/>)
            </div>
				...
				<p><font size="+2">
					<b>
					Raw Grade: <xsl:value-of select="//StudentTrackerGradeDigest/@OverallGrade"/>
					</b>
				</font>
				</p>
                ...
                <div class="OverallGrade">
                    Overall Grade:<xsl:value-of select="//StudentTrackerGradeDigest/@OverallGrade"/>
                </div>
                <div class="MaxGrade">
                    (Possible grades range from <xsl:value-of select="//StudentTrackerGradeDigest/@MinGrade"/> to <xsl:value-of select="//StudentTrackerGradeDigest/@MaxGrade"/>)
                </div>
		...
		<xsl:if test="Tests=node()">
            ...
            <tr>
                <td colspan="2" style="border-top-width:0px">
                    This penalty was triggered by the failure of the following tests:
